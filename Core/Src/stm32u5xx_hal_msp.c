...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PD3     ------> SPI2_MISO
    */
    GPIO_InitStruct.Pin = MS5607_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(MS5607_MOSI_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MS5607_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF3_SPI2;
    HAL_GPIO_Init(MS5607_SCK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MS5607_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(MS5607_MISO_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PD3     ------> SPI2_MISO
    */
    HAL_GPIO_DeInit(MS5607_MOSI_GPIO_Port, MS5607_MOSI_Pin);

    HAL_GPIO_DeInit(MS5607_SCK_GPIO_Port, MS5607_SCK_Pin);

    HAL_GPIO_DeInit(MS5607_MISO_GPIO_Port, MS5607_MISO_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PC5     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = COMPANION_TX_Pin|COMPANION_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART4)
  {
    ...
    PA1     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, GNSS_RX_Pin|GNSS_TX_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PC5     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, COMPANION_TX_Pin|COMPANION_RX_Pin);
